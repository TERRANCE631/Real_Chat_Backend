export const messageQuery__createTable = "CREATE TABLE IF NOT EXISTS messages ( sender_ID INT, receiver_ID INT, message VARCHAR(1000000000), created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, id INT PRIMARY KEY AUTO_INCREMENT )";
...
export const messageQuery__getAllMessages = `SELECT * FROM messages`;
